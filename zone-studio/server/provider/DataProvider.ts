...
export interface DeviceConfig {
   ...
   * (Phase 4). Set by the provider on a polygon-profile device; undefined when the
   * profile is native or MQTT is not relevant. The editor surfaces it so the user
   * knows the live entities require the Home Assistant MQTT integration. It rides
